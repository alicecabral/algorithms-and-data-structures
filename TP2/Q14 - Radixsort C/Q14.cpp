...
// Retorna o jogador com o maior id
...
// Contagem do array de acordo com o digito exp
void countSort(Jogador array[], int n, int exp)
{
    Jogador output[n];
    int i, count[10] = { 0 };
...
int main(){
    ...
    radixsort(jogadores2, numEntrada);
    ...
    FILE *file;
    file = fopen("589690_radixsort.txt", "w");
