...
class Pilha {
    ...
    /**
     * Insere um jogador na ultima posicao da Pilha.
    ...
    /**
     * Remove um jogador da ultima posicao da Pilha.
...
class Q03 {
    ...
    public static void main (String[] args){
        ...
        do {
            ...
            if (!isFim(id)){
                try {
                    pilhaJogadores.inserirFim(jogadores[Integer.parseInt(id)]);
                }
                catch (Exception e) {
        ...
        for(int i = 0; i < n; i++){
            ...
            if(comando[0].compareTo("I") == 0){
                try{
                    pilhaJogadores.inserirFim(jogadores[Integer.parseInt(comando[1])]);
                }
                catch(Exception e){
                ...
                try{
                    System.out.println("(R) " + pilhaJogadores.removerFim().getNome());
                }
                catch(Exception e){
